...
export default function Footer({ foonav }) {
  return (
    <Container maxWidth="500" sx={{ bgcolor: '#9791D8', mt: '100px' }}>
      <Grid container spacing={5} xs={12}>
        <Grid xs={12} md={5} lg={4}>
          <Item style={{ boxShadow: "none" }} sx={{ bgcolor: '#9791D8' }}>
        ...
        >
          <Grid sx={{ order: { xs: 2, sm: 1 } }}>
            <Item style={{ boxShadow: "none" }} sx={{ bgcolor: '#9791D8', color: 'black' }}>Copyright © 2022 by Aaoochale</Item>
          </Grid>
